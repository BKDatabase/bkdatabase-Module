...
local i18n =
{
	["errors"] =
	{
		...
		["entity-not-found"] = "Không tìm thấy thực thể Wikibase.",
		...
		["site-not-found"] = "Không tìm thấy trang dự án.",
		["unknown-datetime-format"] = "Định dạng ngày giờ không rõ.",
		["local-article-not-found"] = "Bài viết chưa được tạo ở wiki này."
	},
	["datetime"] =
	{
		...
		[12] = 'j F "năm" Y lúc ga "giờ"',	-- precision: hour
		[13] = 'j F "năm" Y lúc g:ia',	-- precision: minute
		[14] = 'j F "năm" Y lúc g:i:sa',	-- precision: second
		["beforenow"] = "$1 TCN",	-- how to format negative numbers for precisions 0 to 5
		["afternow"] = "$1 SCN",	-- how to format positive numbers for precisions 0 to 5
