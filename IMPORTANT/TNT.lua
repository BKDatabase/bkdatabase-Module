...
local sanitizeDataset, loadData, link, formatMessage, getCurrentLanguage
...
function p.doc(frame)
	...
	local json, dataPage = implGetTemplateData(nil, dataset, frame.args, lang)
...
getCurrentLanguage = function(lang)
	if lang and lang ~= '' and lang ~= '_' then
		return lang
	end

	return mw.getCurrentFrame():preprocess('{{USERLANGUAGE}}')
end
...
link = function(dataset)
	return 'Data:' .. mw.text.trim(dataset or '')
end
