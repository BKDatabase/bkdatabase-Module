...
return {
	...
	["lsw"] = {"Lalang Siny Seselwa", "Langue des Signes Seychelloise", "Seychelles Sign Language"},
	...
	["xpe"] = {"Liberia Kpelle"},
	["xpf"] = {"Nuenonne", "Southeast Tasmanian"},
	["xpg"] = {"Phrygian"},
